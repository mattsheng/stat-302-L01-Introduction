...
Once Task 4a & 4b are done, we need to connect our local Git with GitHub, the remote Git server. To do so, we need to create a credential (**personal access token or PAT**) and have Git memorizes it.
